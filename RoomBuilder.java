...
/**
  * La clase RoomBuilder crea las estructura de los cuartos y de las salidas 
  * dependiendo de la lectura de la configuración del archivo de texto.
 */
...
public class RoomBuilder {
    ...
    private Collection<Room> obtenerCuartos() {
        ...
        while (scanContenido.hasNextLine()) {
            ...
            listaCuartos.add(cuarto); //Mueve los cuartos al constructor
        }
        agregarSalidas();
        scanContenido.close();
        return listaCuartos;
